...
import com.gag.enterprisewxmobile.tool.common.exception.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
    ...
    public static final String VIDEO_PM4_EXTENSION = ".mp4";
    ...
    public static final String upload(String baseDir, MultipartFile file) throws IOException
    {
        try
        {
            return upload(baseDir, file, FileUploadUtils.EXCEL_XLSX_EXTENSION);
        }
        catch (Exception e)
        {
            throw new IOException(e);
    ...
    public static final boolean mkdir(String uploadDir){
