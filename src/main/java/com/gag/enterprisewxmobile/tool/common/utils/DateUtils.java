...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils
{
    ...
    /**
     * 根据String参数时间"yyyy-MM-dd",转换为date类型,并且date类型输出格式是yyyy-MM-dd
     * 此方法转换后存在时间差异
     * @param datetime
     * @return
     * @throws ParseException
     */
    public static Date transformTime(String datetime) throws ParseException {
        //1、定义转换格式
        SimpleDateFormat formatter  = new SimpleDateFormat("yyyy-MM-dd");
        SimpleDateFormat formatter2  = new SimpleDateFormat("yyyyMMdd");
        //2、调用formatter2.parse(),将"datetime"转化为date类型  输出为：Sat Mar 23 00:00:00 GMT+08:00 1957
        Date  date = formatter2.parse(datetime);
